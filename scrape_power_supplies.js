  ...
  try {
    ...
    for (const row of rows) {
      ...
      csvContent += `"${name}","${imageUrl}","${productUrl}","${price}","${
        ...
        details.type || "N/A"
      }","${details.efficiencyRating || "N/A"}","${
        details.wattage || "N/A"
      }","${details.length || "N/A"}","${details.modular || "N/A"}","${
        details.color || "N/A"
      }","${details.fanless ? "Yes" : "No"}","${
        details.atx4PinConnectors || "N/A"
      }","${details.eps8PinConnectors || "N/A"}","${
        details.pcie12plus4Pin12VHPWRConnectors || "N/A"
      }","${details.pcie12PinConnectors || "N/A"}","${
        details.pcie8PinConnectors || "N/A"
      }","${details.pcie6plus2PinConnectors || "N/A"}","${
        details.pcie6PinConnectors || "N/A"
      }","${details.sataConnectors || "N/A"}","${
        details.molex4PinConnectors || "N/A"
